...
public class ChoosePDFAdapter extends BaseAdapter {
	...
	private int iconForType(ChoosePDFItem.Type type) {
		...
		case DIR: return R.drawable.icon_type_folder;
		case DOC: return R.drawable.icon_type_pdf;
		default: return 0;
		}
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(item.time!=null){
			((TextView)v.findViewById(R.id.time)).setText(item.time);
		}else {
			((TextView)v.findViewById(R.id.time)).setText("");
		}
